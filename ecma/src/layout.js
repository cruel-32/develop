 ...
 * @returns {{ contentEl: HTMLElement, pageIndexEl: HTMLElement }}
 */
export function mountLayout(root) {
  root.innerHTML = `
    <div class="layout">
      <header class="topbar">
        ...
        <span class="topbar-title">ECMAScript 학습실</span>
      </header>
      <div class="body">
        <nav class="sidebar">
  ...
  return {
    contentEl: root.querySelector("#content"),
    pageIndexEl: root.querySelector("#page-index"),
  };
}
